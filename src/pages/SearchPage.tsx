      ...
      <div className="container py-8">
        ...
        <div className="relative max-w-2xl mb-8">
          <input
            ...
            className="w-full h-12 rounded-lg border border-border bg-card text-foreground placeholder:text-muted-foreground px-4 pr-12 text-sm focus:outline-none focus:ring-2 focus:ring-ring"
          />
